...
if (isset($_GET['id']) && $_GET['id'] != '') {
    ...
    if ($check > 0) {
        ...
        header('location:stadiumAgent_management.php');
        die();
    }
}
...
if (isset($_POST['submit'])) {
    ...
    if ($msg == '') {
        if (isset($_GET['id']) && $_GET['id'] != '') {
            ...
            $done = mysqli_query($con, "INSERT INTO `admin_users` (`id`, `fullname`, `username`, `password`, `role`,`stadium_id`) VALUES (NULL, '$name', '$username', '$password', '2','{$_SESSION['ADMIN_STADIUM']}');");
            if (!$done)  $msg = "Error: " . mysqli_error($con);
        }
        header('location:stadiumAgent_management.php');
        die();
...
<div class="content pb-0">
    <div class="animated fadeIn">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header"><strong>ADD NEW STADIUM AGENT</strong><small> </small></div>
