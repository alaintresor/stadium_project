        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form action="process_registration.php" method="post" id="form1">
              ...
              <div class="form-group has-feedback">
                <input name="phone" type="text" placeholder="Mobile Number ex:0780001234" class="form-control" />
                <?php $frm->validate("phone", array("required", "label" => "Mobile Number", "min" => "10", "max" => "10", "regexp" => "mobile")); // Validating form using form builder written in form.php 
                ?>
