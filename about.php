...
?>
						...
						<div class="about-top">
							...
							<div class="desc span_3_of_2">
								...
								<p class="p-link" style="font-size:15px">
									<b>Seats:</b>
								<ul>
									<li><b> VVIP SEATS:</b> <br> No:<?php echo $seat[2]; ?>, Price:<?php echo $seat[3]; ?></li>
									<br>
									<li><b> VIP SEATS:</b> <br> No: <?php echo $seat[4]; ?> ,
										Price:<?php echo $seat[5]; ?></li>
									<br>
									<li><b> Roofed SEATS:</b><br> No:<?php echo $seat[6]; ?>,
										Price:<?php echo $seat[7]; ?></li><br>
									<li><b> UnRoofed SEATS:</b><br> No:<?php echo $seat[8]; ?> ,Price:<?php echo $seat[9]; ?></li>
									</p>
									<p class="p-link" style="font-size:15px">
	...
	if ($currentTime >= $_GET['time']) {
	?>
		<center>
			<script>
				alert(" you can't book ticket of this Match, it already started");
				history.go(-1);
			</script>
		</center>
	<?php
							...
							<div class="about-top">
								...
								<div class="desc span_3_of_2">
									...
									<p class="p-link" style="font-size:15px">
										<b>Seats:</b>
									<ul>
										<li> VVIP SEATS: No:<?php echo $seat[1]; ?>, Price:<?php echo $seat[2]; ?></li>
										<li>VIP SEATS: No: <?php echo $seat[4]; ?> ,
											Price:<?php echo $seat[5]; ?></li>
										<li>Roofed SEATS: No:<?php echo $seat[6]; ?>,
											Price:<?php echo $seat[7]; ?></li>
										<li>UnRoofed SEATS: No:<?php echo $seat[8]; ?> ,Price:<?php echo $seat[9]; ?></li>
										</p>
										<p class="p-link" style="font-size:15px">
											<a href="booking.php?id=<?php echo $_GET['id'] ?>"><button class='btn btn-primary'>Book Now</button></a>
										</p>
