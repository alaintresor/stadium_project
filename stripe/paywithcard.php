...
?>                                   <label class="form-group">Amount:</label>   <input class="form-control" type='text' readonly value='<?php echo $row[0]*$_POST['seats'] ?>' name="amount" > 
                               ...
                               class="stripe-button" data-key="<?php echo $stripe['publishable_key']; ?>"
                                 data-description="Access for a year" data-amount="<?php echo $row[0]*$_POST['seats'] ?>" data-locale="auto"></script>
                                        </div>
                                    </div>
                                    <div class="col-lg-6"><a href="../booking.php?<?php echo $_POST['id'] ?>" class="btn btn-warning btn-block">cancel</a></form>
                                    </div>
                                </div>
                        </fieldset>
                    </div>
